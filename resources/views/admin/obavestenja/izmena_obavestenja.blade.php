@extends('layouts.app')
@section('title', 'Izmena obaveštenja')
...
<div class="container">
    ...
    <div class="card rounded-lg border border-dark bg-gradient-light shadow-lg">
        <div class="card-header text-center">
            <h2 class="font-weight-bold pt-2" style="text-shadow: 2px 2px lightgray">Izmena obaveštenja</h2>
        </div>
        <div class="card-body text-center font-weight-bold">
            <form action={{ route('izmena_obavestenja',['id'=>$obavestenje->id]) }} method="POST">
                @csrf
                <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-lg-12 col-md-12 col-sm-12 ">
                        ...
                        <textarea rows="4" required
                            ...
                            oninput="setCustomValidity('')" type="text"
                            class="form-control @error('obavestenje') is-invalid @enderror" id="obavestenje" name="obavestenje">{{ old('obavestenje') ? old('obavestenje') : $obavestenje->obavestenje }}</textarea>
                        @error('obavestenje')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
