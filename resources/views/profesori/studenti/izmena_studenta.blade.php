@extends('layouts.app')
@section('title','Evidencija Studenata | Izmena studenta ')
                    ...
                    <div class="form-group col-lg-4 col-md-4 col-sm-12 ">
                        ...
                        <div class="input-group">
                            <select class="custom-select mr-sm-2 @error('smer') is-invalid @enderror" id="smer"
                                ...
                                <option value="{{$smer->id}}" @if($smer->id==$student->smer) selected @endif>{{$smer->naziv}}</option>
                                @endforeach
                        </select>
                        </div>
                        @error('smer')
                    ...
                    <div class="form-group col-lg-4 col-md-4 col-sm-12 ">
                        ...
                        <div class="input-group">
                            ...
                            <input required oninvalid="this.setCustomValidity('Molimo unesite broj telefona!')"
                                ...
                                name="broj_telefona"
                                value="0{{old('broj_telefona') ? old('broj_telefona') : $student->broj_telefona}}">
                            @error('broj_telefona')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
